...
const Achivement = () => {
    ...
    return (
        <div className='xl:w-[1280px] lg:w-[1024px] md:w-[768px] sm:w-[500px] mx-auto'>
            ...
            <Slider {...settings}>
                {
                    certificates.map((certificate, index) => (
                        <div key={index} className={`w-[150px] ml-14 ${deviceWidth < 550 ? 'ml-0': deviceWidth > 550 && deviceWidth < 1020 ? 'ml-8': ''}`}>
                            <div key={index} className='bg-[#222068] lg:w-[320px] md:w-[300px] sm:w-[80%} lg:h-[280px] md:h-[260px] rounded-lg p-2 cursor-pointer'>
                                <PhotoProvider>
