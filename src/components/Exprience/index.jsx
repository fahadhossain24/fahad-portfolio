    ...
    return (
        <div id='exprience'  ref={ref} className='xl:w-[1280px] lg:w-[1024px] md:w-[768px] sm:w-[100%] mx-auto'>
            <div className='xl:w-[16%] lg:w-[18%] md:w-[28%] sm:w-[45%] mx-auto mt-20 mb-24'>
                <h2 className='font-bold text-center text-3xl border-b-4 border-b-[#ff6d5a] pb-2 bg-gradient-to-b from-white to-[#ff6d5a] text-transparent bg-clip-text'>Experience</h2>
            </div>
                ...
                <div className='lg:w-[30%] sm:w-[90%] text-[#bbb] border-2 border-blue-500 hover:border-[#ff6d5a] transition-all p-3'>
                    <div>
                        ...
                        <div>
                            ...
                            <h3 className='text-sm'>Aug 2023 - <span className='text-blue-500'>Present</span></h3>
